export default {
  ...
  'privacy.p10': 'We retain personal data only as long as necessary for the purposes outlined in this policy:',
  'privacy.ul10.li1': '<strong>Account Data:</strong> Retained while your account is active, plus 30 days after deletion (to allow reactivation)',
  'privacy.ul10.li2': '<strong>User Posts:</strong> Retained while your account exists. When you delete a post, it\'s permanently removed within 24 hours',
  'privacy.ul10.li3': '<strong>Order Data:</strong> 7 years from date of purchase (French tax law requirement)',
  'privacy.ul10.li4': '<strong>Technical Logs:</strong> IP addresses and security logs retained for 12 months maximum',
  'privacy.ul10.li5': '<strong>Anonymized Analytics:</strong> Retained indefinitely for service improvement (cannot be linked back to you)',
  'privacy.p11': 'After retention periods expire, data is securely deleted from all systems, including backups.',
  'privacy.h3.your_rights': '6. Your Rights Under GDPR',
  'privacy.p12': 'You have the following rights regarding your personal data. To exercise any of these rights, contact us at <strong>privacy@lightmyfire.app</strong>.',
  'privacy.h4.right_access': '6.1. Right of Access (Art. 15 GDPR)',
  'privacy.p13': 'You can request a copy of all personal data we hold about you. We\'ll provide this in a structured, commonly used format within 30 days.',
  'privacy.h4.right_rectification': '6.2. Right to Rectification (Art. 16 GDPR)',
  'privacy.p14': 'You can correct inaccurate or incomplete data. Update most information directly in your profile settings, or contact us for assistance.',
  'privacy.h4.right_erasure': '6.3. Right to Erasure - "Right to be Forgotten" (Art. 17 GDPR)',
  'privacy.p15': 'You can request deletion of your personal data. You can delete individual posts anytime from "My Profile." To delete your entire account and all associated data, contact us at privacy@lightmyfire.app. Note: We may retain certain data if legally required (e.g., order history for tax purposes).',
  'privacy.h4.right_portability': '6.4. Right to Data Portability (Art. 20 GDPR)',
  'privacy.p16': 'You can receive your data in a machine-readable format (JSON/CSV) to transfer to another service.',
  'privacy.h4.right_object': '6.5. Right to Object (Art. 21 GDPR)',
  'privacy.p17': 'You can object to processing based on legitimate interests. We\'ll stop processing unless we demonstrate compelling legitimate grounds.',
