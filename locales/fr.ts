export default {
    ...
    'home.hero.popup_content': 'Le PIN est sur l\'autocollant. C\'est le code unique de ton briquet—son passeport pour un voyage mondial d\'histoires.',
    'home.hero.alt_image': 'LightMyFire - Donne une seconde vie aux briquets',
    'home.pin_entry.title': 'Tu as trouvé un briquet ?',
    'home.pin_entry.subtitle': 'Entre le PIN de son autocollant pour en savoir plus sur ton·ta nouveau·velle compagnon·gne.',
    ...
    'home.become_lightsaver.subtitle': 'Rejoins notre mission pour donner une seconde vie aux briquets. Crée de beaux autocollants, partage des histoires et fais partie d\'une communauté créative mondiale qui combat le gaspillage.',
    ...
    'notifications.login_success': 'Content·e de te revoir, LightSaver ! Tes briquets t\'ont manqué. 💫',
    ...
    'empty_state.no_posts_title': 'L\'histoire de ce briquet attend d\'être écrite !',
    'empty_state.no_posts_message': 'Sois le·la premier·ère à ajouter une publication et commencer son voyage.',
    ...
    'error.generic_title': 'Oups ! Quelque chose s\'est mal passé',
    'error.generic_message': 'Un petit problème de notre côté. Tu veux réessayer ?',
    ...
    'cookie_consent.message': 'Nous utilisons des cookies pour t\'offrir la meilleure expérience sur notre site. En continuant, tu acceptes notre politique de confidentialité et l\'utilisation de cookies.',
    ...
    'how_it_works_details.step1.desc': 'Donne un nom à ton briquet, créant son carnet de voyage numérique. Télécharge ton autocollant PIN/QR unique.',
    'how_it_works_details.step2.title': '2. Partage',
    'how_it_works_details.step2.desc': 'Colle-le et laisse-le partir—donne-le ou « perds-le ». Son voyage commence.',
    ...
    'how_it_works_details.step4.desc': 'Chaque nouvelle personne qui le trouve peut scanner et ajouter son propre post. Tu ne partages pas qu\'une flamme—tu co-écris une chronique mondiale.',
