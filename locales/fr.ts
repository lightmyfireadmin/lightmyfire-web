export default {
  ...
  'email.order_confirmation_subject': 'Commande confirmée ! Tes autocollants LightMyFire sont en route 📦',
  'email.moderator_invite_subject': 'Tu as été invité·e à rejoindre l\'équipe de modération',

  'email.common.footer_tagline': 'LightMyFire – Donne une seconde vie à ton briquet',
  ...
  'email.welcome.intro': 'Bienvenue dans la communauté des LightSavers ! Nous sommes ravi·es de t\'avoir parmi nous.',
  'email.welcome.what_is_title': '🔥 Qu\'est-ce que LightMyFire ?',
  'email.welcome.what_is_content': 'LightMyFire est un mouvement mondial qui donne une seconde vie aux briquets à travers la narration. Chaque briquet obtient une identité numérique, un autocollant unique et voyage à travers le monde en collectant des histoires de tous ceux qui le trouvent.',
  'email.welcome.get_started_title': '🚀 Pour commencer',
  'email.welcome.get_started_intro': 'Voici ce que tu peux faire maintenant :',
  'email.welcome.step1': 'Sauvegarde ton premier briquet - Donne-lui un nom et reçois des autocollants personnalisés à domicile',
  'email.welcome.step2': 'Trouve un briquet - Entre un PIN d\'un autocollant que tu as trouvé pour voir son voyage',
  'email.welcome.step3': 'Rejoins la mosaïque - Partage des posts, des pensées, des chansons et des lieux',
  ...
  'email.order_confirmation.summary_title': '📦 Récapitulatif de la commande',
  'email.order_confirmation.order_id': 'ID de commande :',
  'email.order_confirmation.stickers': 'Autocollants :',
  ...
  'email.order_confirmation.shipping_title': '📮 Expédition vers',
  'email.order_confirmation.whats_next_title': '⏰ Et après ?',
  'email.order_confirmation.whats_next_content': 'Tes autocollants sont en cours de préparation pour l\'expédition. Tu recevras un autre email avec les informations de suivi une fois qu\'ils seront en route !',
  ...
  'email.order_shipped.intro': 'Tes autocollants personnalisés LightMyFire ont été expédiés et sont en route vers toi.',
  ...
  'email.order_shipped.lighters_intro': 'Tu as commandé {quantity} autocollants personnalisés pour :',
  'email.order_shipped.pro_tip': '💡 Astuce :',
  'email.order_shipped.pro_tip_content': 'Tes briquets sont déjà actifs ! Commence à ajouter des posts maintenant en attendant que tes autocollants arrivent.',
  ...
  'email.first_post.what_started_title': '🎯 Ce que tu as lancé',
  'email.first_post.what_started_content': 'Ton briquet fait maintenant partie de quelque chose de spécial. Chaque fois que quelqu\'un le trouve et ajoute son histoire, tu pourras voir où il a été et les connexions qu\'il a créées.',
  'email.first_post.lighter': 'Briquet :',
  'email.first_post.pin': 'PIN :',
  'email.first_post.type': 'Type du premier post :',
  'email.first_post.next_steps_title': '💡 Prochaines étapes',
  'email.first_post.next_step1': 'Partage-le : Passe-le à un·e ami·e ou laisse-le dans un endroit intéressant',
  'email.first_post.next_step2': 'Obtiens des autocollants : Commande des autocollants personnalisés pour aider les autres à trouver l\'histoire de ton briquet',
  'email.first_post.next_step3': 'Regarde-le grandir : Reviens voir les nouveaux posts au fur et à mesure que ton briquet voyage',
  ...
  'email.trophy.keep_going': '💡 Continue comme ça !',
  'email.trophy.keep_going_content': 'Il y a d\'autres trophées qui attendent d\'être débloqués. Peux-tu tous les collecter ?',
  ...
  'email.activity.outro': 'Le voyage de ton briquet continue ! Découvre où il a été et qui l\'a trouvé.',
  ...
  'email.moderator.intro': '{inviter} t\'a invité·e à rejoindre l\'équipe de modération de LightMyFire !',
  'email.moderator.what_is_title': '👮 Qu\'est-ce qu\'un·e modérateur·rice ?',
  'email.moderator.what_is_content': 'Les modérateur·rices aident à garder la communauté LightMyFire sûre, positive et accueillante en examinant le contenu signalé et en veillant au respect de nos directives communautaires.',
  'email.moderator.responsibilities_title': '📋 Tes responsabilités',
  'email.moderator.benefits_title': '🎁 Avantages de modérateur·rice',
  ...
  'email.moderator.benefit4': 'Aide à façonner l\'avenir de la communauté',
  'email.moderator.not_interested': 'Pas intéressé·e ? Tu peux ignorer cet email.',
...
Trouve un briquet et ajoute ton premier post.',
  ...
  'order.custom.branding.email': 'orders@lightmyfire.app',
  ...
  'privacy.p15': 'Tu disposes des droits suivants concernant tes données personnelles. Pour exercer l\'un de ces droits, contacte-nous à <strong>support@lightmyfire.app</strong>.',
  ...
  'privacy.p18': 'Tu peux demander la suppression de tes données personnelles. Tu peux supprimer des posts individuels à tout moment depuis « Mon Profil ». Pour supprimer l\'intégralité de ton compte et toutes les données associées, contacte-nous à support@lightmyfire.app. Note : Nous pouvons conserver certaines données si cela est légalement requis (par ex., historique des commandes pour des raisons fiscales).',
  ...
  'privacy.p2': 'Le responsable du traitement de tes données personnelles est :<br><br><strong>Revel Editions SASU</strong><br>145 Rue de Noisy-le-Sec<br>93260 Les Lilas, France<br><br><strong>Email de contact :</strong> support@lightmyfire.app<br><strong>Délégué à la protection des données :</strong> support@lightmyfire.app',
  ...
  'privacy.ul16.li2': '<strong>Délégué à la protection des données :</strong> support@lightmyfire.app',
  ...
  'terms.p20': 'Si tu crois que du contenu a été supprimé ou que ton compte a été suspendu par erreur, tu peux faire appel en contactant support@lightmyfire.app dans les 30 jours de l\'action. Inclus :',
  ...
  'terms.p33': 'Avant de déposer toute réclamation formelle, tu acceptes de nous contacter à support@lightmyfire.app pour tenter de résoudre le litige de manière informelle. Nous nous engageons à travailler avec toi de bonne foi pour parvenir à une résolution dans les 60 jours.',
