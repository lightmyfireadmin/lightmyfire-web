export default {
    ...
    'email.moderator.what_is_title': '👮 Qu\'est-ce qu\'un modérateur ?',
    'email.moderator.what_is_content': 'Les modérateurs aident à garder la communauté LightMyFire sûre, positive et accueillante en examinant le contenu signalé et en s\'assurant que nos directives communautaires sont respectées.',
    'email.moderator.responsibilities_title': '📋 Tes responsabilités',
    'email.moderator.benefits_title': '🎁 Avantages du modérateur',
    'email.moderator.benefit1': 'Accès anticipé aux nouvelles fonctionnalités',
    'email.moderator.benefit2': 'Badge spécial de modérateur sur ton profil',
