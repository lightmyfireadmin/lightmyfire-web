export default {
  ...
  'add_post.button.checking_alt': 'तपासत आहे...',

  'add_post.button.checking_content': 'सामग्री तपासत आहे...',

  'add_post.button.loading_alt': 'लोड होत आहे...',

  'add_post.button.search': 'शोधा',

  'add_post.button.select': 'निवडा',

  'add_post.char_counter': '{remaining} अक्षरे शिल्लक आहेत',

  'add_post.error.cooldown_active': 'तुम्ही या लायटरवर {hours} तासांनंतर पुन्हा पोस्ट करू शकता. कृपया पुन्हा पोस्ट करण्यापूर्वी प्रतीक्षा करा.',

  'add_post.error.cooldown_check_failed': 'पोस्टिंग पात्रता सत्यापित करू शकत नाही. कृपया पुन्हा प्रयत्न करा.',

  'add_post.error.file_too_large': 'फाइल खूप मोठी आहे. 2MB पेक्षा लहान फाइल निवडा.',

  'add_post.error.invalid_latitude': 'अक्षांश -90 आणि 90 च्या दरम्यान असणे आवश्यक आहे.',

  'add_post.error.invalid_longitude': 'रेखांश -180 आणि 180 च्या दरम्यान असणे आवश्यक आहे.',

  'add_post.error.text_too_long': 'मजकूर खूप लांब आहे. जास्तीत जास्त {max} अक्षरांना परवानगी आहे.',

  'add_post.error.youtube_api_error': 'YouTube API त्रुटी: {message}',

  'add_post.moderation.content_review': '⚠️ सामग्री पुनरावलोकन',

  'add_post.moderation.tip': '💡 सूचना: समुदाय-अनुकूल होण्यासाठी सुधारणा करण्याचा विचार करा.',

  'add_post.options': 'पर्याय',

  'add_post.placeholder.location_lat': 'अक्षांश (उदा., 48.8566)',

  'add_post.placeholder.location_lng': 'रेखांश (उदा., 2.3522)',

  'add_post.placeholder.location_name': 'Name of a place (e.g., \\'Cafe Central\\')',

  'add_post.prompt_v1': 'या लायटरमध्ये कोणती आठवण आहे? त्याची कथा सांगा...',

  'add_post.prompt_v2': 'तुम्हाला ते कुठे सापडले? पुढे काय झाले?',

  'add_post.prompt_v3': 'A thought, a poem, a moment—share what\\'s on your mind...',

  'add_post.prompt_v4': 'कोणते गाणे वाजत आहे? वातावरण वर्णन करा...',

  'add_post.prompt_v5': 'जर हे लायटर बोलू शकले असते तर काय बोलले असते?',

  'add_post.select_post_type': 'पोस्ट प्रकार निवडा',

  'add_post.youtube_search.selected_video': 'निवडलेला व्हिडिओ:',

  'add_post.youtube_search.video_preview': 'व्हिडिओ पूर्वावलोकन:',

  'admin.orders.action.refund': 'परतावा',

  'admin.orders.action.refunded': 'परतावा दिला',

  'admin.orders.action.refunding': 'परतावा देत आहे...',

  'admin.orders.action.send_fulfillment': '📧 पूर्तीसाठी पाठवा',

  'admin.orders.action.sending': 'पाठवत आहे...',

  'admin.orders.confirm_resend': 'ऑर्डर {orderId} साठी स्टिकरसह पूर्ती ईमेल पुन्हा पाठवायचा...?',

  'admin.orders.details.full_order_id': 'संपूर्ण ऑर्डर ID',

  'admin.orders.details.na': 'उपलब्ध नाही',

  'admin.orders.details.payment_intent_id': 'पेमेंट इंटेंट ID',

  'admin.orders.details.refund_info': 'परतावा माहिती',

  'admin.orders.details.shipping_address': 'शिपिंग पत्ता',

  'admin.orders.details.title': 'ऑर्डर तपशील',

  'admin.orders.details.user_email': 'वापरकर्ता ईमेल',

  'admin.orders.no_orders': 'कोणतेही ऑर्डर सापडले नाहीत.',

  'admin.orders.pack_size_count': '{count} स्टिकर',

  'admin.orders.pending_refunds': 'प्रलंबित परतावे',

  'admin.orders.refund_confirm': 'तुम्हाला खात्री आहे की तुम्ही {email} ला €{amount} परत करू इच्छिता?',

  'admin.orders.refund_error': 'परतावा अयशस्वी: {error}',

  'admin.orders.refund_failed': 'परतावा अयशस्वी',

  'admin.orders.refund_success': 'परतावा यशस्वी! रक्कम: €{amount}',

  'admin.orders.refunded': 'परतावा दिला',

  'admin.orders.resend_error': '❌ पुन्हा पाठवणे अयशस्वी: {error}',

  'admin.orders.resend_failed': 'पूर्ती ईमेल पुन्हा पाठवणे अयशस्वी',

  'admin.orders.resend_success': '✅ Fulfillment email resent successfully!\n\n{count} sticker(s) sent to fulfillment team.',

  'admin.orders.table.actions': 'क्रिया',

  'admin.orders.table.amount': 'रक्कम',
  ...
  'admin.orders.table.pack_size': 'पॅक आकार',

  'admin.orders.table.status': 'स्थिती',

  'admin.orders.total_orders': 'एकूण ऑर्डर',

  'admin.orders.total_revenue': 'एकूण उत्पन्न',

  'alt.arrow_save_lighter': 'लायटर जतन बटणाकडे बाण दर्शवितो',

  'alt.butane_lighter': 'ब्युटेन रिफिलेबल लायटर',

  'alt.butane_refill_process': 'ब्युटेन लायटर रिफिल प्रक्रिया',

  'alt.community': 'समुदाय',

  'alt.creative': 'सर्जनशील',

  'alt.gasoline_lighter': 'गॅसोलिन रिफिलेबल लायटर',

  'alt.gasoline_refill_process': 'गॅसोलिन लायटर रिफिल प्रक्रिया',

  'alt.lighter_illustration': 'लायटर चित्रण',

  'alt.lightmyfire_logo': 'लाइटमायफायर',

  'alt.lightmyfire_tagline': 'लाइटमायफायर - लायटरांना दुसरे जीवन द्या',

  'alt.non_refillable_lighter': 'नॉन-रिफिलेबल लायटर',

  'alt.personalise': 'वैयक्तिकृत करा',

  'alt.qr_code': 'QR कोड',

  'alt.sustainable': 'टिकाऊ',

  'aria.close_notification': 'सूचना बंद करा',

  'aria.global': 'जागतिक',

  'aria.hex_color': 'HEX रंग कोड',

  'aria.learn_levels': 'स्तर कसे मिळवायचे ते शिका',

  'aria.popular_colors': 'लोकप्रिय रंग पॅलेट',

  'aria.search_location': 'ठिकाण शोधा',

  'auth.already_have_account': 'आधीपासून खाते आहे? साइन इन करा',

  'auth.continue_with': 'सोबत सुरू ठेवा',

  'auth.dont_have_account': 'Don\\'t have an account? Sign up',

  'auth.email_label': 'ईमेल',

  'auth.email_placeholder': 'तुम्ही@example.com',

  'auth.forgot_password': 'तुमचा पासवर्ड विसरलात?',

  'auth.password_label': 'पासवर्ड',

  'auth.password_placeholder': 'तुमचा पासवर्ड',
  ...
  'auth.signing_up': 'साइन अप करत आहे...',

  'color.blue_violet': 'निळा जांभळा',

  'color.bright_yellow': 'चमकदार पिवळा',

  'color.coral_red': 'कोरल लाल',

  'color.deep_pink': 'गडद गुलाबी',

  'color.forest_green': 'जंगली हिरवा',

  'color.golden_yellow': 'सोनेरी पिवळा',

  'color.light_gray': 'हलका राखाडी',

  'color.light_green': 'हलका हिरवा',

  'color.light_pink': 'Light Pink',

  'color.royal_blue': 'Royal Blue',

  'color.sky_blue': 'आकाशी निळा',

  'color.sunset_orange': 'सूर्यास्त केशरी',

  'color.turquoise': 'फिरोजा',

  'color.warm_orange': 'Warm Orange',

  'common.loading_alt': 'लोड होत आहे...',

  'contact.button': 'Contact Us',

  'contact.cancel': 'रद्द करा',
  ...
  'home.become_lightsaver.alt_arrow': 'लायटर जतन बटणाकडे बाण दर्शवितो',

  'home.community.alt': 'Community illustration',

  'home.hero.alt_image': 'लाइटमायफायर - लायटरांना दुसरे जीवन द्या',
  ...
  'lighter.meta.description': 'See the story of a lighter named ',
  ...
  'login.forgot_password': 'तुमचा पासवर्ड विसरलात?',

  'login.social_divider': 'or continue with',

  'login.tab.login': 'लॉग इन करा',
  ...
  'my_orders.shipping.title': 'शिपिंग पत्ता',
  ...
  'my_profile.settings.username_label': 'वापरकर्तानाव',
  ...
  'settings.profile.username_label': 'वापरकर्तानाव',
  ...
  'validation.email_invalid': 'कृपया वैध ईमेल पत्ता टाका.',

  'validation.email_required': 'ईमेल आवश्यक आहे.',

  'validation.field_required': 'हे फील्ड आवश्यक आहे.',

  'validation.password_requirement.lowercase': 'किमान एक लहान अक्षर',

  'validation.password_requirement.min_length': 'किमान {count} अक्षरे',

  'validation.password_requirement.number': 'किमान एक संख्या',

  'validation.password_requirement.uppercase': 'किमान एक मोठे अक्षर',

  'validation.password_requirements': 'पासवर्डमध्ये किमान एक मोठे अक्षर, एक लहान अक्षर आणि एक संख्या असणे आवश्यक आहे',

  'validation.password_too_short': 'पासवर्ड किमान {min} अक्षरांचा असणे आवश्यक आहे.',
