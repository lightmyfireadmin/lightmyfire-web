 ...
 *
 * @param {string | null} code - The 2-letter country code (e.g., 'US', 'FR').
 ...
 *
 * @param {string | null} code - The 2-letter country code.
 * @returns {string} The full country name, or the code if name not found.
 */
