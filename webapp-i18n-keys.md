...
notifications.post_success="Story added! 🎉 You just made this lighter's journey a little brighter."
notifications.post_success_first="Congratulations! 🌟 You just lit the first spark in this lighter's story."
...
error.generic_message="Something went wrong on our end. Give it another try?"
...
cookie.message="We use cookies only for basic functionality—never for tracking. Your privacy is protected. See our {privacyLink} for details."
...
add_post.subtitle.text="Story, Thought, Poem"
add_post.subtitle.song="YouTube"
add_post.subtitle.image="Screenshot"
add_post.subtitle.location="Where Found It"
add_post.subtitle.refuel="Lighter Refill"
...
add_post.moderation.tip="💡 Tip: Consider revising your content to be more community-friendly."
...
settings.auth.error.passwords_no_match="Passwords do not match."
settings.auth.success_message="Update successful! Please check your email to confirm the changes if you updated your email address."
settings.auth.title="Account Settings"
settings.auth.oauth_notice="✓ You are logged in via {provider}. Your authentication is managed securely by your provider."
settings.auth.current_email="Current Email"
settings.auth.email_managed_by="Your email is managed by your {provider} account."
settings.auth.change_via_provider="To change your email or authentication method, please visit your {providerLink} settings."
...
- This file contains all 988 English translation keys from the LightMyFire webapp
- Keys are organized by feature/section for easy reference
- All client-side text elements (excluding admin & moderation panels) are included
- Translation variables use {variable} syntax
- HTML tags are preserved where needed (e.g., <strong>, <sup>)
- Use this as the master reference for translating into all 22+ supported languages
