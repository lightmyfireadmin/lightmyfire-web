...
const ANNOUNCEMENT_CONTENT = {
  en: {
    ...
    content: `Hi! We are so excited to have you here. We are just starting this platform and are committed to make it even **better**. Don't hesitate to contact us at **mitch@lightmyfire.app** to share your **feedback & opinion**, we are looking forward to hearing from you! In the meantime, we apologise for any inconvenience resulting from implementing phase - you may run into a couple bugs, translation typos, super generic community posts made to test script functionality. Orders may take a **couple days more to arrive** than in the long run. Thank you sincerely for your **understanding** and thank you for visiting **lightmyfire.app**!`,
  },
  fr: {
    title: "Nous ne faisons que commencer",
    content: `Salut ! Nous sommes ravis de t'accueillir ici. Nous venons de lancer cette plateforme et nous nous engageons à la rendre encore **meilleure**. N'hésite pas à nous contacter à **mitch@lightmyfire.app** pour partager tes **retours & opinions**, nous avons hâte de te lire ! En attendant, nous nous excusons pour tout désagrément lié à la phase de lancement - tu pourrais rencontrer quelques bugs, coquilles de traduction, ou des publications génériques créées pour tester les fonctionnalités. Les commandes peuvent prendre **quelques jours de plus** que par la suite. Merci sincèrement pour ta **compréhension** et merci de visiter **lightmyfire.app** !`,
  },
  de: {
    title: "Wir fangen gerade erst an",
    content: `Hallo! Wir freuen uns so sehr, dass du hier bist. Wir starten gerade diese Plattform und sind entschlossen, sie noch **besser** zu machen. Zögere nicht, uns unter **mitch@lightmyfire.app** zu kontaktieren, um dein **Feedback & deine Meinung** zu teilen - wir freuen uns darauf, von dir zu hören! In der Zwischenzeit entschuldigen wir uns für eventuelle Unannehmlichkeiten während der Startphase - du könntest auf ein paar Bugs, Übersetzungsfehler oder generische Community-Posts stoßen, die zum Testen der Funktionen erstellt wurden. Bestellungen können **ein paar Tage länger dauern** als später üblich. Vielen Dank für dein **Verständnis** und danke, dass du **lightmyfire.app** besuchst!`,
  },
  es: {
    title: "Apenas estamos comenzando",
    content: `¡Hola! Estamos muy emocionados de tenerte aquí. Acabamos de lanzar esta plataforma y nos comprometemos a hacerla aún **mejor**. No dudes en contactarnos en **mitch@lightmyfire.app** para compartir tus **comentarios y opiniones**, ¡esperamos saber de ti! Mientras tanto, pedimos disculpas por cualquier inconveniente durante la fase de lanzamiento - podrías encontrar algunos bugs, errores de traducción, o publicaciones genéricas creadas para probar funcionalidades. Los pedidos pueden tardar **un par de días más** de lo habitual al principio. Gracias sinceramente por tu **comprensión** y gracias por visitar **lightmyfire.app**!`,
  },
};
